...
CI (`.github/workflows/`) builds and pushes the connector image to our private ECR repo `822461550840.dkr.ecr.eu-central-1.amazonaws.com/athena-prod-mongo-connector-v2`. Two triggers:
